// Shared harness for the Reveal.js/Slidev parity demos. Deliberately does
// NOT override `background` — same convention as the GSAP/p5.js campaigns:
// render()'s default is black (#000000, src/node.ts) and Text defaults to
// WHITE, sidestepping the invisible-text-on-white-background bug class the
// ECharts campaign hit repeatedly.
//
